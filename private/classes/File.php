...
class File {
	...
	public static function exts_by_mime($type)
	{
		...
		if (empty($types))
		{
			foreach (Config::fact('mimes')->get() as $ext => $mimes)
			{
	...
	/**
	 * file : 'C:\wamp\www\stdcms\private\app\upload\577c512fd640b.jpg'
	 * 
	 * 			File::get_filename($file); // 577c512fd640b.jpg
	 * 
	 * @param string $file
	 * @return string
	 */
	 ...
	 * file : 'C:\wamp\www\stdcms\private\app\upload\577c512fd640b.jpg'
	 * 
	 * 			   File::sufname($file, '_s'); // 577c512fd640b_s.jpg
	 *			or File::sufname($file, '_s', true); // C:\wamp\www\stdcms\private\app\upload\577c512fd640b_s.jpg
	 * 
	 * @param string $file
	 * @param string $suf
	 * @param bool $path
	 * @return string
	 */
	public static function sufname($file, $suf, $path = false)
	{
		$info = new SplFileInfo($file);
	 ...
	 * file : 'C:\wamp\www\stdcms\private\app\upload\577c512fd640b.jpg'
	 * 
	 * 			File::get_ext($file); // C:\wamp\www\stdcms\private\app\upload
	 * 
	 * @param string $file
	 * @return string
	 */
	...
	/**
	 * file : 'C:\wamp\www\stdcms\private\app\upload
	 * 
	 * 			File::get_ext($file); // upload
	 * 
	 * @param string $file
	 * @return string
	 */
	public static function get_basename($file)
	{
		$info = new SplFileInfo($file);
